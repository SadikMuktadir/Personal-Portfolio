...
const WhyHire = () => {
  return (
    <div className="bg-[#F2F4F7] px-[30px] py-[100px] flex flex-col lg:flex-row">
      <div className="mr-[50px] flex flex-col lg:flex-row items-center">
        <img src="https://i.ibb.co/kgbwq8G/output-onlinegiftools.gif" alt="" />
      </div>
      <div className="w-[250px] lg:w-[700px]">
        <p className="mb-[40px] text-[40px] lg:text-[64px] font-bold">
          Why <span className="text-[#FD853A]">Hire me</span>?
        </p>
        <p className="text-[15px] lg:text-[20px] font-sm mb-[50px]">
          {" "}
        ...
        <div>
          ...
          <Link to="/contact">
            <div
              className="mt-[40px] text-[#171717] hover:text-white bg-white hover:bg-[#FD853A] w-[200px] lg:w-[250px] rounded-[35px] px-[60px] py-[30px]"
